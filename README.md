...
> [!TIP]
> First time contributing to open source? Come say hello in the [Discord](https://discord.gg/VQF23tPKyK).

Contributions are welcome! Whether it's a bug report, a suggestion, or a pull request, or even just using and sharing
the site – all help is appreciated.

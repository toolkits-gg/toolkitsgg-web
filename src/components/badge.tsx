...
const colors = {
  ...
  accent1:
    'bg-accent1-500/15 text-accent-foreground group-data-hover:bg-accent1-500/25 dark:bg-accent1-500/10 dark:text-accent-foreground dark:group-data-hover:bg-accent1-500/20',
  accent2:
    'bg-accent2-500/15 text-accent-foreground group-data-hover:bg-accent2-500/25 dark:bg-accent2-500/10 dark:text-accent-foreground dark:group-data-hover:bg-accent2-500/20',
  accent3:
    'bg-accent3-500/15 text-accent-foreground group-data-hover:bg-accent3-500/25 dark:bg-accent3-500/10 dark:text-accent-foreground dark:group-data-hover:bg-accent3-500/20',
};

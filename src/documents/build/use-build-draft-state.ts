...
import type { BuildDetailsValue } from "#/documents/build/build-editor/BuildDetailsFields.tsx";
import { useDraftDescription } from "#/documents/build/use-draft-description.ts";
import type {
	BuildLoadoutEntry,
	CreatedBuildRecord,
} from "#/features/game/data/types.ts";
import { toImageFit } from "#/features/image-position/image-fit.ts";
import { toImagePosition } from "#/features/image-position/image-position.ts";
import {
	type BuildDraftParams,
	buildDraftParsers,
} from "#/features/search-params/parsers/build-draft.ts";

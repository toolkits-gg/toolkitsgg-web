...
import { getGameItems } from "#/games-registry/public-registry.ts";

type BuildPreviewDocumentProps = { builds: GameBuildsConfig };
 ...
 */
const BuildPreviewDocument = ({ builds }: BuildPreviewDocumentProps) => {

// Sync handler for the clairObscurCollectedItem entity (presence toggle).
...
const clairObscurCollectedItemSyncHandler: SyncHandler =
	createCollectedItemSyncHandler(prisma.clairObscurCollectedItem);

export { clairObscurCollectedItemSyncHandler };

// Sync handler for the slayTheSpire2CollectedItem entity (presence toggle).
...
const slayTheSpire2CollectedItemSyncHandler: SyncHandler =
	createCollectedItemSyncHandler(prisma.slayTheSpire2CollectedItem);

export { slayTheSpire2CollectedItemSyncHandler };
